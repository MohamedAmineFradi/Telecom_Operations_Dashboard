...
BUSINESS_CHECKS=(
  ...
  "alert-service-high-snapshot|http://localhost:8101/api/alerts/high/snapshot?limit=5|json-2xx"
  "alert-service-critical-snapshot|http://localhost:8101/api/alerts/critical/snapshot?limit=5|json-2xx"
...
GATEWAY_BUSINESS_CHECKS=(
  ...
  "gateway-alerts-high-snapshot|http://localhost:8090/api/alerts/high/snapshot?limit=5|json-2xx"
  "gateway-alerts-critical-snapshot|http://localhost:8090/api/alerts/critical/snapshot?limit=5|json-2xx"
  ...
  "gateway-mobility-cell-flows|http://localhost:8090/api/mobility/cell-flows?limit=10|json-2xx"
  ...
  "gateway-mobility-stream-alias-current|http://localhost:8090/api/mobility/current/stream?intervalMs=1000|sse-200"
  "gateway-mobility-stream-alias-flows|http://localhost:8090/api/mobility/flows/stream?intervalMs=1000|sse-200"
  "gateway-mobility-stream-alias-cell|http://localhost:8090/api/mobility/cell-flows/stream?intervalMs=1000|sse-200"
  "gateway-mobility-stream-alias-province|http://localhost:8090/api/mobility/province-flows/stream?intervalMs=1000|sse-200"
  "gateway-mobility-stream-alias-summary|http://localhost:8090/api/mobility/province-summary/stream?intervalMs=1000|sse-200"
